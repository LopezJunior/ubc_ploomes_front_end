        ...
        >
          <S.Content>
            ...
            <article>
              ...
              <br /> Você quer competir conosco?? Hahahaha!!
              <br />
              Você ainda precisa treinar muito na nossa academia antes de
              disputar com alguém. Por enquanto você só vai lutar contra o seu
              reflexo, esse é o caminho do auto-desenvolvimento.
              <br />
              <br />
              <b>Arrume um espaço para você:</b>
              <br />
              Escolha quantas cartelas você precisa (1 a 3), a velocidade do
              sorteio (1s a 10s) e quantas bolas serão suficientes para você
              Bingar (limite de sorteio)!!
            </article>
            <br />
            ...
            <article>
              <b>Presta atenção!!</b>
              <br />
              Você pode marcar a sua cartela à vontade, mas não adianta roubar
              no jogo, os juízes consideram apenas os números marcados que já
              foram sorteados.
            </article>
